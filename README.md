...
- parto de una pregunta de negocio,
- preparo datos confiables,
- construyo análisis, KPIs y dashboards,
- aplico modelos solo cuando aportan valor,
- y documento límites, métricas y reproducibilidad.
