...
export const uiEs = {
  ...
  projects: {
    ...
    lead:
      'Nueve sistemas, ordenados por prioridad editorial. PROVIDENTIA, Caelum, Paradigm y Soma son los cuatro casos principales; el resto sigue siendo accesible.',
    ...
    mapMeta3: '09 NODOS / 03 TERRITORIOS',
    openProject: 'Abrir',
    ...
    groups: {
      ...
      additional: {
        ...
        notes: {
          ...
          'Apache Airflow': 'orquestación local',
          Terraform: 'IaC · arquitectura',
  ...
  contact: {
    ...
    closeout: {
      ...
      selectedWork: 'PROVIDENTIA / Caelum / Paradigm',
...
export const uiEn = {
  ...
  projects: {
    ...
    lead:
      'Nine systems, ordered by editorial priority. PROVIDENTIA, Caelum, Paradigm, and Soma are the four primary cases; the rest stay fully accessible.',
    ...
    mapMeta3: '09 NODES / 03 TERRITORIES',
    openProject: 'Open',
